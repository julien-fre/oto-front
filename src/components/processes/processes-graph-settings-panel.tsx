...
import { DISPLAY_RANGES } from "@/components/knowledge/graph-canvas";
import type { GraphSettings } from "@/lib/processes-graph-settings";
import { COLOR_BY_LABELS, type ColorBy } from "@/lib/processes-graph";

// Same four groups, same fixed order, same "all collapsed at rest" as
// knowledge/graph-settings-panel.tsx — this domain just has fewer filters
// (no branch/freshness dimension, no unresolved-node toggle) and different
// copy for what's left.
...
export function ProcessesGraphSettingsPanel({
  settings,
  onChange,
  onReset,
  onClose,
        ...
        >
          ...
          >
            ...
            <input
              ...
              placeholder="Search processes and connectors"
          ...
          <ToggleRow
            label="Orphans"
            hint="Processes with no detected connector"
